<template>
  <div class="statistic container">
    ...
    <div v-else-if="records.length">
      ...
      <!--          <td class="count"><span>{{ record.countEmotions }}</span>-->
      ...
      <!--            </svg>-->
      <!--          </td>-->
      <!--          <td><span class="date">{{ new Date(record.date).toLocaleDateString() }}</span> <i class="material-icons mobile">touch_app</i></td>-->

      <!--          <td class="category"><span>{{ record.categoryTitle }}</span> <i class="material-icons">{{ record.icon }}</i></td>-->
      <!--          <td :class="record.type === 'outcome' ? 'lost' : 'add'"-->
      <!--              style="">{{ record.type === 'outcome' ? '-' : '+' }}</td>-->
      <!--          <td>-->
      <!--            <button @click="deleteRecord" :data-id="record.id"><i class="material-icons">delete</i></button>-->
      <!--          </td>-->
      <!--&lt;!&ndash;          <td @click="showInfo">&ndash;&gt;-->
      <!--&lt;!&ndash;            <button :data-id="record.id" style="pointer-events: none"><i class="material-icons">info</i></button>&ndash;&gt;-->
      <!--&lt;!&ndash;          </td>&ndash;&gt;-->
      <!--          <td class="done loader" :id="record.id">-->
      <!--            <Loader/>-->
      <!--          </td>-->
      <!--        </tr>-->
      <!--        </tbody>-->
